...
<?php
    ...
    if($data && is_array($data)) {
        // pagination
        $limit = 15; //number of records per pgae
...
usort($data, function($a, $b) use ($sortColumn, $sortOrder) {
    ...
    return $sortOrder === 'asc' ? strcmp($a[$sortColumn], $b[$sortColumn]) : strcmp($b[$sortColumn], $a[$sortColumn]);
        ...
        echo "</tbody>";
        echo "</table>";
        echo "<div style = 'margin: 1.25rem 0 0 2rem; display: flex; gap: 10px; color:#117a65;'>";
        ...
        echo "<div style='margin: 1.25rem 0 0 2rem; color: #117a65; '>";
