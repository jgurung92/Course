...
if(isset($_POST['submit'])) {
    ...
    if ($result !== false) {
        ...
        // Retrieve admin details of the logged-in user for logging
        $admin_id = $_SESSION['admin_id'];  // Assuming logged-in admin's ID is stored in session
        $admin_username = $_SESSION['user']; // Assuming logged-in admin's username is stored in session
        $activity_description = "$admin_username added a new admin with username $username";
        $action = "add-admin";
